...
export function isChannel(arg: any): arg is IChannel {
  return typeof arg.id === 'string' && typeof arg.teamId === 'string' && typeof arg.description === 'string' && typeof arg.name === 'string';
}
...
export function isMessage(arg: any): arg is IMessage {
  return typeof arg.teamId === 'string' && typeof arg.channelId === 'string' && typeof arg.userId === 'string' && typeof arg.body === 'string';
}
